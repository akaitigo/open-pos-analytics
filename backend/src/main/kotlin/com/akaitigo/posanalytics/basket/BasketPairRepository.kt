 ...
 */
@ApplicationScoped
class BasketPairRepository(private val entityManager: EntityManager) {

    fun topPairs(segment: BasketSegment, sort: BasketSortKey, limit: Int): List<BasketPair> {
    ...
    private fun toPair(row: Array<Any?>): BasketPair = BasketPair(
